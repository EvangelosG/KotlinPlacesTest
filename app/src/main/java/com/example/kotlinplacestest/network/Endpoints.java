...
public class Endpoints {
    public static final String PLACES_URL = "https://maps.googleapis.com/maps/api/place/textsearch/json?query=Popeyes&rankby=distance&key=" + BuildConfig.PLACES_API_KEY;
